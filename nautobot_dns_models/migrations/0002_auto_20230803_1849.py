...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='zone',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='mxrecordmodel', related_query_name='mxrecordmodel', to='nautobot_dns_models.dnszonemodel'),
        ),
        migrations.AlterField(
            model_name='nsrecordmodel',
            name='zone',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='nsrecordmodel', related_query_name='nsrecordmodel', to='nautobot_dns_models.dnszonemodel'),
        ),
        migrations.AlterField(
            model_name='txtrecordmodel',
            name='zone',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='txtrecordmodel', related_query_name='txtrecordmodel', to='nautobot_dns_models.dnszonemodel'),
        ),
    ]
